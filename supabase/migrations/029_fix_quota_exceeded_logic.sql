-- Migration 029: Fix Quota Exceeded Logic
-- Remove the "used < limit_value" condition from UPDATE to allow proper quota exceeded detection
...
BEGIN
    ...
    EXCEPTION
        WHEN unique_violation THEN
            ...
            -- FIXED: Removed "used < limit_value" condition to allow quota to increment to 6
            UPDATE daily_quotas
            SET 
                used = used + 1,
                updated_at = NOW()
