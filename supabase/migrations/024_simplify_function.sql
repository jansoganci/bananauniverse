-- Migration 024: Simplify consume_quota function with robust UPSERT logic
-- Uses a more straightforward approach with proper error handling
...
BEGIN
    ...
    -- Use a simple UPSERT approach with proper error handling
    BEGIN
        -- Try to insert first
